...
from utils.llm_client import groq_narrate
...
class ExplainerAgent:
    ...
    def explain(
        ...
        md_path = f"/app/data/reports/compliance_{contract_id}_{period}.md"
        ...
        pdf_path = f"/app/data/reports/compliance_{contract_id}_{period}.pdf"
        try:
            pdf_exporter.export_compliance_report(md_path, output_dir="/app/data/reports")
        ...
        summary_path = f"/app/data/reports/risk_summary_{contract_id}_{period}.json"

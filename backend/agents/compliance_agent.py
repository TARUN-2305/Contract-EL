...
class ComplianceAgent:
    ...
    def _load_rule_store(self, contract_id: str) -> dict:
        ...
        path = f"/app/data/rule_store/rule_store_{contract_id}.json"
    ...
    def run(self, exec_data: dict) -> dict:
        ...
        os.makedirs("/app/data/compliance", exist_ok=True)
        period = exec_data.get("reporting_period") or "unknown"
        path = f"/app/data/compliance/compliance_{contract_id}_{period}.json"

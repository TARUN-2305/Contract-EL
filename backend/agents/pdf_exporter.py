...
class PDFExporter:
    ...
    def export_compliance_report(self, compliance_md_path: str, output_dir: str = "/app/data/reports") -> str:
...
The contractor has missed the M1 milestone by 15 days.
    """
    out = exporter.md_to_pdf(test_md, "/app/data/reports/test_report.pdf")
